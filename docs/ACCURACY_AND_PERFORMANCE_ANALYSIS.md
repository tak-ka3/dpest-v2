...
| アルゴリズム | 入力サイズ | 手法 | 実行時間 | 備考 |
|------------|----------|------|---------|------|
| LaplaceMechanism | 1 | 解析 | 0.01s | 最高速 |
| LaplaceParallel | 20 | 解析 | 0.02s | 並列独立 |
| NoisyHist1 | 5 | 解析 | 0.04s | - |
| NoisyHist2 | 5 | 解析 | 0.03s | - |
| ReportNoisyMax1 | 5 | 解析 | 2.72s | Argmax演算 |
| ReportNoisyMax2 | 5 | 解析 | 2.71s | Argmax演算 |
| ReportNoisyMax3 | 5 | 解析 | 2.71s | - |
| ReportNoisyMax4 | 5 | 解析 | 2.72s | - |
| OneTimeRAPPOR | 1 | 解析 | 0.00s | 離散演算 |
| RAPPOR | 1 | 解析 | 0.00s | 離散演算 |
| NoisyMaxSum | 20 | 解析 | 24.27s | 複雑な max |
| SVT1 | 10 | サンプリング | 273.63s | Branch依存 |
| SVT2 | 10 | サンプリング | 282.52s | Branch依存 |
| SVT3 | 10 | サンプリング | 46.03s | 早期終了 |
| SVT4 | 10 | サンプリング | 307.74s | Branch依存 |
| SVT5 | 10 | サンプリング | 24.81s | 早期終了 |
| SVT6 | 10 | サンプリング | 281.40s | - |
| NumericalSVT | 10 | サンプリング | 58.76s | 早期終了 |
| PrefixSum | 10 | サンプリング | 125.87s | 累積依存 |
| SVT34Parallel | 10 | サンプリング | 105.44s | - |
| TruncatedGeometric | 5 | サンプリング | 23.62s | Branch依存 |
